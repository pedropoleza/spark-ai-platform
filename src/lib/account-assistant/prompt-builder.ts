...
export function buildSparkbotSystemPrompt(args: BuildPromptArgs): string {
  ...
  return [
    ...
    "",
    "REGRAS DE USO:",
    "- create_task ≠ schedule_reminder. create_task = task no GHL CRM (visível pro rep no app GHL); schedule_reminder = msg proativa que o Sparkbot manda no WhatsApp do rep.",
