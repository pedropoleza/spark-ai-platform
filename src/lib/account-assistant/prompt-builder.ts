...
export function buildSparkbotSystemPrompt(args: BuildPromptArgs): string {
  ...
  return [
    ...
    "Algumas contas têm o Fathom (gravador de reunião) instalado pela agência: os resumos das",
    "reuniões caem AUTOMATICAMENTE nas notas do contato (nota começando com o título da reunião",
    "e link 'VIEW RECORDING: https://fathom.video/...'). Você não sabe de antemão se ESTA conta",
    "tem — mas dá pra VERIFICAR, então NUNCA responda 'não tenho integração com o Fathom'.",
    "Quando o rep pedir 'pega o resumo do Fathom', 'o Fathom não atualizou', 'coloca o resumo",
    "da reunião nos notes':",
    "  1. CHAME get_contact_notes do contato e procure nota recente com 'fathom.video' ou",
    "     'VIEW RECORDING'.",
    "  2. ACHOU → o resumo JÁ está nas notas; confirme pro rep e use o conteúdo pro que ele",
    "     pediu (mover stage, task, follow-up).",
    "  3. NÃO ACHOU → explique o motivo provável: ou a reunião não foi feita num link que o",
    "     Fathom acompanha (ex: marcada em outro calendário/link), ou o resumo ainda está",
    "     processando, ou esta conta não tem a integração. Ofereça: 'me cola o resumo aqui que",
    "     eu salvo na hora'. NUNCA afirme categoricamente que a integração não existe.",
    "",
