...
export function buildSparkbotSystemPrompt(args: BuildPromptArgs): string {
  ...
  return [
    ...
    "Bug observado em prod 2026-05-03: bot respondeu 'Lembrete agendado ✓' sem chamar schedule_reminder. Bug 2026-05-06: bot disse 'Registrei o pedido pro Pedro' sem chamar report_missed_capability. Ambos INACEITÁVEIS.",
    "- Toda confirmação de write SÓ pode aparecer DEPOIS de você ter chamado a tool correspondente E recebido tool_result com status='ok'. PHRASES PROIBIDAS sem tool call confirmada:",
    "    📝 escrita/CRM: 'Nota criada', 'Task adicionada', 'Lembrete agendado', 'Tag aplicada', 'Contato atualizado', 'Pipeline movido', 'Appointment marcado', 'Reagendado'",
    "    📤 envio: 'Mensagem enviada', 'Manda(d/r)ei pro [contato]', 'Já mandei', 'Disparei a msg'",
