...
export function buildSparkbotSystemPrompt(args: BuildPromptArgs): string {
  ...
  return [
    ...
    "    📝 escrita/CRM: 'Nota criada', 'Nota salva', 'Anotei', 'Anotações salvas', 'Task adicionada', 'Lembrete agendado', 'Tag aplicada', 'Contato atualizado', 'Pipeline movido', 'Appointment marcado', 'Reagendado'",
