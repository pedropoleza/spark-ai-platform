...
export const updateAgentConfigSchema = z.object({
  ...
  targeting_rules: z.array(targetingRuleSchema).optional(),
  enabled_channels: z.array(z.enum(["SMS", "WhatsApp", "Instagram", "Email"])).optional(),
  calendar_id: z.string().nullable().optional(),
  tone_creativity: z.number().min(0).max(100).optional(),
  tone_formality: z.number().min(0).max(100).optional(),
  tone_naturalness: z.number().min(0).max(100).optional(),
  tone_aggressiveness: z.number().min(0).max(100).optional(),
  ...
  knowledge_base_instructions: z.string().optional(),
  system_prompt_override: z.string().nullable().optional(),
  debounce_seconds: z.number().min(5).max(60).optional(),
  max_messages_per_conversation: z.number().min(10).max(200).optional(),
  working_hours: workingHoursSchema.optional(),
  follow_up_config: followUpConfigSchema.optional(),
  ...
  check_legal_docs: z.boolean().optional(),
