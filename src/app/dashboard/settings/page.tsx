          ...
          <CardContent className="space-y-3">
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <Input value={webhookUrl} readOnly className="font-mono text-xs bg-neutral-50" />
                <Button
                  variant="outline"
                  size="icon"
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <Input value={locationId} readOnly className="font-mono text-xs bg-neutral-50" />
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => copyToClipboard(locationId, "location")}
                >
                  {copied === "location" ? <CheckCircle2 className="w-4 h-4 text-green-600" /> : <Copy className="w-4 h-4" />}
                </Button>
              </div>
            </div>
          </CardContent>
